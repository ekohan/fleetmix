...
class TestCoordinateConverter(unittest.TestCase):
    ...
    def test_convert_all_coordinates_to_geographic(self):
        ...
        geo_coords = converter.convert_all_coordinates(
            self.cvrp_coords, to_geographic=True
        )
    ...
    def test_convert_all_coordinates_to_cvrp(self):
        ...
        cvrp_coords_back = converter.convert_all_coordinates(
            geo_coords, to_geographic=False
        )
    ...
    def test_cosine_correction(self):
        ...
        expected_x_scale = (
            self.custom_bounds.lon_span * cos_lat / (converter.max_x - converter.min_x)
        )
