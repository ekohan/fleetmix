...
def base_config_path():
    ...
    return Path(__file__).parent.parent / "_assets" / "configs" / "base_test_config.yaml"


@pytest.fixture
def minimal_config_path():
    """Path to minimal test configuration."""
    return Path(__file__).parent.parent / "_assets" / "configs" / "test_config_minimal.yaml"
...
def test_optimize_with_json_format(simple_demand_df, tmp_path):
    ...
    config_path = Path(__file__).parent.parent / "_assets" / "configs" / "test_config_bhh.yaml"
