...
class TestExplodeCustomer:
    ...
    def test_single_good_customer(self):
        ...
        assert pseudo_customers[0].demands == {
            "dry": 10.0,
            "chilled": 0.0,
            "frozen": 0.0,
        }
    ...
    def test_two_goods_customer(self):
        ...
        combined_pseudo = next(
            pc for pc in pseudo_customers if pc.customer_id == "C001::dry-chilled"
        )
        ...
        chilled_only = next(
            pc for pc in pseudo_customers if pc.customer_id == "C001::chilled"
        )
