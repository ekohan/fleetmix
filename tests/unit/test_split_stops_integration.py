    ...
    def test_split_stop_mode(self, sample_demand_data, minimal_config):
        ...
        for customer_id in served_pseudo_customers:
            if '::' in customer_id:  # It's a pseudo-customer
                ...
                customer_row = sample_demand_data[sample_demand_data['Customer_ID'] == customer_id].iloc[0]
                goods_needed = set()
        ...
        for _, customer_row in sample_demand_data.iterrows():
            ...
            assert required_goods.issubset(covered_goods), f"Customer {customer_id} missing goods: {required_goods - covered_goods}"
