...
from fleetmix.utils.project_root import get_project_root, PROJECT_ROOT
...
class TestProjectRoot(unittest.TestCase):
    ...
    def test_get_project_root_invalid_environment(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                self.assertTrue((root / "pyproject.toml").exists() or 
                              (root / ".git").exists() or 
                              (root / "src" / "fleetmix").exists())
    ...
    def test_project_root_constant(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(fleetmix.utils.project_root.PROJECT_ROOT.resolve(), 
